        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <h2>Oficina Administrativa</h2>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                    <ul class="bread-list">
                        <li><a href="index.html">Home<i class="fa fa-angle-right"></i></a></li>
                        <li class="active"><a href="#">Oficina Administrativa<i class="fa fa-angle-right"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-event">
                        <div class="event-image">
                            <a href="<?php echo IMAGES.'oficina.jpeg' ?>">
                                <img src="<?php echo IMAGES.'oficina.jpeg' ?>" alt="#">
                            </a>
                        ...
                        <div class="event-content">
                            <h3 class="event-title"><a href="<?php echo IMAGES.'oficina.jpeg' ?>">Horario Esis 2020</a></h3>
