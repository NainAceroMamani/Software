        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3 col-12">
                <div class="section-title bg">
                    <h2>Estudiantes de Intercambio </h2>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-course">
                        <!-- Course Head -->
                        <div class="course-head overlay">
                            <img src="<?php echo IMAGES.'convenios/convenio1.jpg' ?>" alt="#">
                            <a href="#" target="black" class="btn white primary">Ver Universidad</a>
                        </div>
                        <!-- Course Body -->
                        <div class="course-body">
                            <div class="name-price">
                                ...
                                <span class="price">UTEA</span>
                            </div>
                            <h4 class="c-title"><a href="#" target="black">UNIVERSIDAD TECNOLOGICA DE LOS ANDES</a></h4>
                            <p>La Universidad César Vallejo es una universidad peruana privada ubicada en el distrito Víctor Larco en la ciudad de Trujillo, en la costa de la región de La Libertad. </p>
                        </div>
                    </div>
                    <!--/ End Single Course -->
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-course">
                        <!-- Course Head -->
                        <div class="course-head overlay">
                            <img src="<?php echo IMAGES.'convenios/convenio2.jpg' ?>" alt="#">
                            <a href="#" target="black" class="btn white primary">Ver Universidad</a>
                        </div>
                        <!-- Course Body -->
                        <div class="course-body">
                            ...
                            <h4 class="c-title"><a href="#" target="black">UNIVERSIDAD PRIVADA DE TACNA</a></h4>
                            <p>La Universidad César Vallejo es una universidad peruana privada ubicada en el distrito Víctor Larco en la ciudad de Trujillo, en la costa de la región de La Libertad. </p>
                        </div>
                    </div>
                    <!--/ End Single Course -->
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-course">
                        <!-- Course Head -->
                        <div class="course-head overlay">
                            <img src="<?php echo IMAGES.'convenios/convenio3.jpg' ?>" alt="#">
                            <a href="#" target="black" class="btn white primary">Ver Universidad</a>
                        </div>
                        <!-- Course Body -->
                        <div class="course-body">
                            ...
                            <h4 class="c-title"><a href="#" target="black">UNIVERSIDAD CESAR VALLEJO</a></h4>
                            <p>La Universidad César Vallejo es una universidad peruana privada ubicada en el distrito Víctor Larco en la ciudad de Trujillo, en la costa de la región de La Libertad. </p>
                        </div>
                    </div>
                    <!--/ End Single Course -->
